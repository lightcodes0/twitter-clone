    ...
    return (
        <div className="flex space-x-3 p-3 border-b border-gray-700">
            ...
            {(!loading && <div className="w-full">
                <textarea className="bg-transparent resize-none outline-none 
                w-full min-h-[50px] text-lg" placeholder="what's on your mind?"
            ...
            {image && (
                <div className="relative mb-4">
                    ...
                    bg-[#272c26] rounded-full w-8 h-8 flex items-center justify-center
